export default function DiagonalRoute({ className }: { className?: string }) {
  return (
    ...
    >
      ...
      <path d="M0 24 Q 150 70, 258 146" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
      <path d="M64 0 Q 180 55, 266 150" stroke="currentColor" strokeWidth="4" strokeLinecap="round" />
      ...
      <circle cx="400" cy="260" r="9" fill="currentColor" />
    </svg>
  )
}
